...
class Building:
    ...
    def collect_production(self, info: BuildingInfo, resource_manager: ResourceManager) -> float:
        ...
        production = self.get_total_production_per_second(info) * time_elapsed
...
class BuildingManager:
    ...
    def __init__(self, resource_manager: ResourceManager):
        ...
        self.building_info = {
            ...
            BuildingType.MINE: BuildingInfo(
                ...
                base_cost=500,
                base_production=2.0,
                production_resource=ResourceType.IRON,
                unlock_level=12
            ),
            BuildingType.SAWMILL: BuildingInfo(
                ...
                base_cost=300,
                base_production=1.5,
                production_resource=ResourceType.WOOD,
                unlock_level=10
            ),
            BuildingType.QUARRY: BuildingInfo(
                ...
                base_cost=800,
                base_production=1.2,
                production_resource=ResourceType.STONE,
                unlock_level=18
            ),
            BuildingType.LABORATORY: BuildingInfo(
                ...
                base_cost=2500,
                base_production=3.0,
                production_resource=ResourceType.EXPERIENCE,
                unlock_level=25
            ),
            BuildingType.REACTOR: BuildingInfo(
                ...
                base_cost=5000,
                base_production=5.0,
                production_resource=ResourceType.ENERGY,
                unlock_level=30
            ),
            BuildingType.PORTAL: BuildingInfo(
                ...
                base_cost=50000,
                base_production=0.1,
                production_resource=ResourceType.CRYSTALS,
                unlock_level=50
            )
        }
    ...
    def collect_all_production(self) -> dict:
        ...
        for building_type, building in self.buildings.items():
            info = self.building_info[building_type]
            collected = building.collect_production(info, self.resource_manager)

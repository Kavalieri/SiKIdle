...
class IdleAchievementManager:
	...
	def __init__(self, database):
		...
		logging.info(f"IdleAchievementManager initialized with {len(self.achievements)} achievements")
	...
	def _create_idle_achievements(self):
		...
		achievements_data = [
			# IDLE CATEGORY - Logros de progresión básica
			{
				...
				"target_value": 1,
				"reward": IdleAchievementReward(click_multiplier=0.1, coins_reward=10, gems_reward=5)
			},
			{
				"id": "clicks_100",
				"name": "Clicker Novato",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 100,
				"reward": IdleAchievementReward(click_multiplier=0.2, coins_reward=100, gems_reward=10)
			},
			{
				"id": "clicks_1000",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 1000,
				"reward": IdleAchievementReward(click_multiplier=0.5, coins_reward=1000, gems_reward=25)
			},
			{
				"id": "first_building",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 1,
				"reward": IdleAchievementReward(building_multiplier=0.1, coins_reward=50, gems_reward=8)
			},
			{
				"id": "buildings_10",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 10,
				"reward": IdleAchievementReward(building_multiplier=0.2, coins_reward=500, gems_reward=15)
			},
			{
				"id": "buildings_50",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 50,
				"reward": IdleAchievementReward(building_multiplier=0.5, coins_reward=5000, gems_reward=40)
			},
			{
				"id": "coins_1k",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 1000,
				"reward": IdleAchievementReward(coins_multiplier=0.1, coins_reward=200, gems_reward=12)
			},
			{
				"id": "coins_100k",
				"name": "Rico",
				...
				"category": IdleAchievementCategory.IDLE,
				"target_value": 100000,
				"reward": IdleAchievementReward(coins_multiplier=0.3, coins_reward=10000, gems_reward=30)
			},
			{
				"id": "coins_1m",
				"name": "Millonario",
				...
				"reward": IdleAchievementReward(coins_multiplier=0.5, coins_reward=100000, gems_reward=50)
			},
			...
			# PRESTIGE CATEGORY - Logros de prestigio
			{
				...
				"target_value": 1,
				"reward": IdleAchievementReward(prestige_bonus=0.1, coins_reward=1000, gems_reward=20)
			},
			{
				"id": "prestige_5",
				...
				"category": IdleAchievementCategory.PRESTIGE,
				"target_value": 5,
				"reward": IdleAchievementReward(prestige_bonus=0.2, coins_multiplier=0.2, gems_reward=35)
			},
			{
				"id": "crystals_10",
				...
				"category": IdleAchievementCategory.PRESTIGE,
				"target_value": 10,
				"reward": IdleAchievementReward(prestige_bonus=0.3, building_multiplier=0.3, gems_reward=60)
			},
	...
	def get_achievements_by_category(self, category: IdleAchievementCategory) -> List[IdleAchievement]:
